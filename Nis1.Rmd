...
`PROC = 2` indicates the number of processors to use for this analysis; depending on teh number of cores in one's computer this number can be increased to speed up the analysis;
